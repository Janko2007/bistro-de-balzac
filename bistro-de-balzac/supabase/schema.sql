...
-- ---------------------------------------------------------------------
-- 6.2 KORPA — obrisani popisi se čuvaju 12 sati
--
--   „Obriši“ ne briše odmah: ceo popis (izveštaj, stavke, ko je radio,
--   slike) se prepiše u `report_trash` kao jedan zapis, a iz glavnih tabela
--   nestane. Zato ga odmah ne računaju ni Pregled, ni uplate, ni dnevnice,
--   a radnik može ponovo da otvori istu smenu.
--
--   12 sati vlasnik može da ga vrati (restore_report). Posle toga ga
--   purge_report_trash briše zauvek i vraća putanje slika, koje aplikacija
--   briše iz storage-a.
-- ---------------------------------------------------------------------
